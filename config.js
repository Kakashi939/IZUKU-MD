...
global.sudo = process.env.SUDO || '22367542669,22367542669'
global.devs = '22367542669,22367542669';
...
module.exports = {
  ...
  ownername: process.env.OWNER_NAME === undefined ? 'Ping-pong' : process.env.OWNER_NAME,
